...
"                                  Linters—ALE                                 "
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Single dual-editor linting stack (replaces syntastic on vim and neomake on
" nvim, both archived/dropped — see PLUGINS.md, 2026-09-07).
...
if g:vim_minimal == 0
  ...
  " Quiet the same noisy pylint codes the old syntastic/neomake configs suppressed.
